            ...
            <div class="cardstats">
                <div class="content">
                    ...
                    <h4 style={{fontSize:"175%", textTransform:"uppercase", fontFamily:"Oswald",}}>Market Cap</h4>
                        <br/>
                        <h1 className="datatext" style={{ textTransform:"uppercase", fontFamily:"Pieces NFI"}}>333&nbsp;<svg width="40.5" height="38" viewBox="0 0 101 88" fill="none" xmlns="http://www.w3.org/2000/svg">
